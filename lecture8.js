  ...
  return `<div class="screen-scroll">
    ...
    <div class="card" style="border-color:#6e5000;background:#1a1200;">
      ...
      <div style="font-size:12px;color:var(--muted);line-height:2.1;">
        • <span style="color:var(--red);font-weight:700">Ch</span> [쩌/쪼] 첫자음 [ㅉ] / 끝자음 [익,ㄷ]<br>
        • <span style="color:var(--red);font-weight:700">Tr</span> [쩌/쪼] : 혀를 입천장에 <span style="color:var(--accent)">강하게</span> 밀며<br>
...
function renderL8C1() {
  const items = [
    {
      char: 'Ch', label: 'chờ · 쩌', sound: 'ㅉ / 익,ㄷ',
      note: '첫자음: [ㅉ] / 끝자음: [익] 북부, [ㄷ/ㄹ] 남부<br>✓ 혀를 입천장 <span style="color:var(--accent)">앞쪽으로</span>',
      endNote: '🔑 끝자음 ~ch<br>• 북부: <span style="color:#f7c948">\'~익\' 받침으로 발음</span> (ex. cách → 까익)<br>• 남부: <span style="color:#f87171">\'ㄷ/ㄹ\' 받침으로 발음</span> (ex. cách → 깐)',
      examples: [
        { vi: 'cách',  ko: '수단, 방법', pron: '까익/깐' },
...
function renderL8C2() {
  ...
  return `${renderConsonantCards(items).replace('<div class="screen-scroll">', `<div class="screen-scroll">
    <div class="card">
      ...
      ${[
        ...
        { vi: 'Thi trước.',  ko: '먼저 시험 보다.',   pron: '티 쩌억/티 쪽' },
      ].map(s => `
  ...
  return `<div class="screen-scroll">
    <div class="card">
      ...
      <div style="background:#1a0a1a;border:1.5px solid #5a2a5a;border-radius:12px;padding:12px;font-size:12px;color:#d4a0ff;line-height:1.9;">
        ...
        &nbsp;&nbsp;&nbsp;• 남부: <span style="color:#f87171">['ㄷ/ㄹ'] 받침</span> (cách → 깐)
      </div>
    </div>
